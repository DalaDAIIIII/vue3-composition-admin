 ...
 * @Version: 1.0
 * @Author: zhouda
 * @Date: 2023-03-10 22:22:09
 * @LastEditors: zhouda
 * @LastEditTime: 2023-03-12 20:33:53
-->
<template>
  <div
    :id="id"
...
export default defineComponent({
  props: {
    ...
    id: {
      type: String,
      default: 'effectScatterChartsCompoents'
    },
    width: {
      type: String,
      default: '100%',
  ...
  value: number
    ...
    const initChart = () => {
      const option = init(document.getElementById(props.id) as HTMLDivElement)
